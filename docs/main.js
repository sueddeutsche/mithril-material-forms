...
function displayRenderer(item, attrs) {
    ...
    if (descriptionProp && item[descriptionProp]) {
        return mithril__WEBPACK_IMPORTED_MODULE_0___default()("span", mithril__WEBPACK_IMPORTED_MODULE_0___default()("span.value", item[attrs.valueProp]), mithril__WEBPACK_IMPORTED_MODULE_0___default()("span.description", item[descriptionProp]));
    }
    return mithril__WEBPACK_IMPORTED_MODULE_0___default()("span.value", item[attrs.valueProp]);
}
/**
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    view(vnode) {
        ...
        const textareaAttributes = {
            ...
            class: `${(_b = attrs.theme) !== null && _b !== void 0 ? _b : _types__WEBPACK_IMPORTED_MODULE_2__["THEME_DEFAULT"]} ${(_c = attrs.class) !== null && _c !== void 0 ? _c : ""}`,
